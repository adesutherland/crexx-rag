...
| Provider-neutral LLM/embedding (`rxllm` candidate) | [`phase1b/provider/`](phase1b/provider/) | [use](phase1b/provider/README.md), [system](phase1b/provider/SYSTEM.md), [package](phase1b/provider/PACKAGE.toml), [bundle](phase1b/provider/BUNDLE.tsv) | Implemented cREXX incubation with a P2-09 review bundle and zero-call four-cell probe; hosted cREXX response completion, provider-lifetime scope, installed package proof, selected downstream Linux replay, catalogue policy and donation approval remain open |
