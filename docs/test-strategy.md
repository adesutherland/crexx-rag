...
| `query_policy` | configured local/hosted routes accept all supported source labels; invalid routes/missing providers and every call/token/cost/allowance ceiling |
