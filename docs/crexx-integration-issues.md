...
`develop` at revision `e3d6b7b9015847d247ab2b90e83c843881db9b2f`,
built out of tree and installed only into the fresh scratch prefix retained in
the [current integration evidence](evidence/2026-08-23-crexx-current-integration/README.md).
...
- The installed-only 62-test inventory passes 62/62 in one fresh current-head
  replay. The earlier split broad/focused preservation result remains retained
...
including the current-head 62/62 replay. Final downstream Linux/package
publication remains open. The Phase-1B work and Gate 1B remain accepted, and
this capability stream does not reorder Phase 2.
