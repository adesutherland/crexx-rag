...
| Phase 8 | Opportunity report maintained 2026-08-25; Gate 8 not satisfied | Candidate, installed-adoption, compatibility, and retirement states now reflect the closed macOS provider/worker findings while retaining lifetime, second-consumer, installed-package, comparison, Linux, ownership and cutover limits. Phase 8 deliberately adds no runtime command or tutorial. No submission, cutover, deletion, release, or push occurred or is implied. |
