...
> [!CAUTION]
> Archived RAG-specific native-v1 bridge pattern. Phase 1A must design generic,
> typed, independently testable facilities rather than reproduce this fixed-JSON
> boundary.
