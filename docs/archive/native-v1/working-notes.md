...
> [!CAUTION]
> Frozen native-v1 engineering notes. Preserve measurements and decisions as
> historical evidence; do not use this file as current architecture.
...
- `docs/archive/native-v1/graph-retrieval-methodology.md` records the retrieval argument: graph
  ...
  model, or Gemma.
- `docs/archive/native-v1/framework-closure-plan.md` records the generic end-to-end lifecycle
...
is archived in `docs/archive/native-v1/crexx-plugin-pattern.md`: compile with
`-i` so `rxc` can
