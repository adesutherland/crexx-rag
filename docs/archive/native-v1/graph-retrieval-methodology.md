...
> [!CAUTION]
> Archived native-v1 algorithm-evolution record. Preserve its evidence lessons
> for Phase 0, but use the current specification and architecture for ownership
> and interfaces.
