...
2026-08-04. Phase 1B is complete, Gate 1B is accepted, and Phase 2 has started
from its pushed entry baseline. `P2-01` is accepted and `P2-02` is pending.
...
| [Implementation roadmap](crexx-only-implementation-roadmap.md) | Completed work, future phases, and gates; Phase 2 is active through accepted `P2-01` |
