...
| RAG-MNT-007 | Local item-5 R1–R5 review repair; focused synthetic acceptance passed, formal qualification pending | Large concept questions retain an explicitly incomplete inventory. Native passage/catalogue inspection now fits both row and 8,192-byte bounds with exact cursor continuation; an unrepresentable single row enters a technical hold. Exact reads and targeted candidate binding preserve identity, including model-facing concept aliases. Uninspected evidence cannot justify whole-subject negative or retain decisions; exhausted partial acquisition has a scoped `acquisition-wait` outcome with durable debt. Fresh extraction citation corrections again check the full serialized request before a new call; maintenance overflow retains a measured hold. Scoped reviewed refresh accepts native unresolved technical holds and inherited pending `evidence-limit` successors after a changed envelope or configuration; both remain subject to pending-review, active-ownership and exact-plan guards. Changed evidence releases an acquisition or inspection hold only when its specific bound is gone; still-blocked questions remain held, while fulfilled waits and settled successors do not revive obsolete origins. Synthetic direct and real-provider loopback controls pass, including a late grounded proposal awaiting human review, ordinary/advanced partial waits and genuine source absence. Receipts, usage and lineage remain inspectable. No protected-corpus, hosted, installation or publication acceptance has been run. [Ownership and focused evidence](maintenance-refactoring-delivery.md#26-september-bounded-large-evidence-item-5); [coverage](regression-coverage.md#26-september-bounded-large-evidence-item-5). |
