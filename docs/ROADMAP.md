...
| C1 / C2 | Content-quality follow-ups | Figurative-place classification / rejected identity selection. Keep uncertainty and source evidence; no automatic software-defect classification. [Corpus findings](smoke-tests-1-5-20260914.md#content-follow-ups). |
...
| RAG-SMK-003 | Repaired and installed | Maintenance checkpoint heartbeat scope; [recovery evidence](recovery-defects.md). |
...
issues at reconciliation; upstream #699 remains open and #701 is now closed. The absence of GitHub
...
| CREXX #699 — source-import compiler failure | Upstream investigation; contained locally | Supported `lineout(stream)` close form builds successfully. No reduced reproducer or retest of the original failure on the latest runtime is claimed. [Integration evidence](integration-issues.md#installed-compiler-source-import-finding-during-t7-10), [issue](https://github.com/adesutherland/CREXX/issues/699). |
