...
foreach(mode IN ITEMS noopt opt)
    if(CPRAG_MODE AND NOT CPRAG_COMPILE_ONLY AND NOT mode STREQUAL CPRAG_MODE)
        continue()
    endif()
    set(mode_flag)
    ...
    foreach(runtime_name IN ITEMS rxvme rxbvm)
        if(CPRAG_RUNTIME AND NOT runtime_name STREQUAL CPRAG_RUNTIME)
            continue()
        endif()
...
if(CPRAG_COMPILE_ONLY)
    file(WRITE "${CPRAG_WORK_DIR}/compiled.stamp" "protocol scenarios built\n")
    return()
endif()
if(NOT CPRAG_TURNOVER)
    if(utf8_failures)
