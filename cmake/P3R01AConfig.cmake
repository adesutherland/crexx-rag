foreach(required_var CPRAG_RXC CPRAG_RXAS CPRAG_RXVME CPRAG_RXBVM
        ...
        CPRAG_APPLICATION CPRAG_WORK_DIR)
...
set(secret_marker "P3R_01A_SECRET_MUST_NOT_APPEAR_8A21")
foreach(mode IN ITEMS noopt opt)
    ...
    foreach(runtime_name IN ITEMS rxvme rxbvm)
        ...
        if(NOT vm_result EQUAL 0 OR NOT vm_out MATCHES
                "P3R_01A_CONFIG_OK cell=${cell} format=1 settings=bounded providers=2 gemini=2 env_refs=2 literal_secrets=0 executable_modules=0 provider_calls=0")
...
message(STATUS
    "P3R-01A passed bounded text config projection in four compiler/VM cells and the linked CLI")
