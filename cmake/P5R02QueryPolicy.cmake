...
set(imports "${CPRAG_WORK_DIR};${CPRAG_APPLICATION_DIR};${CPRAG_PROVIDER_DIR};${CPRAG_CREXX_BIN_DIR}/providers;${CPRAG_CREXX_BIN_DIR}")
...
foreach(mode IN ITEMS noopt opt)
    ...
    foreach(runtime_name IN ITEMS rxvme rxbvm)
        ...
        if(NOT run_result EQUAL 0 OR NOT run_out MATCHES "P5R_02_QUERY_POLICY_OK")
...
file(WRITE "${CPRAG_WORK_DIR}/result.txt"
    "P5R-02 query privacy and every call, Codex-turn, input-token, output-token and cost ceiling passed in noopt/opt on rxvme/rxbvm.\n")
message(STATUS "P5R-02 passed query privacy and budget policy in four compiler/VM cells")
