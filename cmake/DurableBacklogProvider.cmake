...
if(NOT DEFINED CPRAG_CASES)
    set(CPRAG_CASES valid malformed rejected manual concurrent budget continuation correction correction-failed correction-budget)
endif()
...
foreach(case IN LISTS CPRAG_CASES)
    ...
    elseif(case STREQUAL "budget" OR case STREQUAL "continuation")
    ...
    execute_process(COMMAND "${CPRAG_SQLITE}" "${database}"
        ...
        COMMAND_ERROR_IS_FATAL ANY)
    if(case STREQUAL "concurrent" OR case STREQUAL "budget" OR case STREQUAL "continuation")
        set(note_extra ${concurrent_extra})
        if(case STREQUAL "budget" OR case STREQUAL "continuation")
            set(note_extra 3)
        endif()
        execute_process(COMMAND "${CPRAG_SQLITE}" "${database}"
    ...
    if(case STREQUAL "continuation")
        ...
        run_cli(second --format json --access control worker start --max-polls 1 --job "${continuing_job}")
    ...
    elseif(case STREQUAL "valid" OR case STREQUAL "concurrent" OR case STREQUAL "budget" OR case STREQUAL "continuation")
