...
foreach(mode IN ITEMS noopt opt)
    foreach(runtime_name IN ITEMS rxvme rxbvm)
        ...
        execute_process(COMMAND "${runtime}" -l "${program_import}"
            ...
            provider_contract provider_catalog provider_facade provider_http industrial_provider
...
if(NOT final_server_out MATCHES "connections=24 request_connection_close=24")
