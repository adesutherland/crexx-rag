...
export CREXX_RAG_RUNTIME="$runtime"
export CREXX_RAG_IMAGE="$application"
export CREXX_RAG_LOAD_PATH="$load_path"
export CREXX_RAG_SELF=crexx-rag
...
foreach(runtime IN ITEMS "${CPRAG_RXVME}" "${CPRAG_RXBVM}")
    ...
    execute_process(
        COMMAND /bin/sh "${driver}" "${runtime}" "${load_path}"
            "${CPRAG_APPLICATION}" "${library}" "${cell_dir}"
    ...
    if(NOT init_out MATCHES "\"schema_version\":5" OR
