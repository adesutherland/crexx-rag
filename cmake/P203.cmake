...
foreach(schema_line IN LISTS schema_lines)
    if(schema_line MATCHES "if version = ([1234]) then do")
        set(active_migration "${CMAKE_MATCH_1}")
    elseif(schema_line MATCHES "if version = ([1234]) then return \"([0-9a-f]+)\"")
...
foreach(mode IN ITEMS noopt opt)
    ...
    foreach(runtime_name IN ITEMS rxvme rxbvm)
        ...
        run_scenario("${runtime}" "${program}" "${cell}" full
            "${library_path}" 0
            "P2_03_FULL_OK cell=${cell} levelg=1 schema=4 migrations=4 tables=33 generations=2 snapshots=2 manifest_recovery=1 rollback=1")
